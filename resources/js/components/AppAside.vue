  ...
  <CSidebar color-scheme="light" size="lg"  overlaid  placement="end"  :visible="asideVisible" >
    ...
    <CTabContent>
      <CTabPane :visible="activeKey == 1">
        <CListGroup flush>
          <CListGroupItem class="list-group-item border-start-4 border-start-secondary bg-light text-center fw-bold text-medium-emphasis text-uppercase small" >
            Today
          </CListGroupItem>
          ...
          <CListGroupItem class="border-start-4 border-start-secondary bg-light text-center fw-bold text-medium-emphasis text-uppercase small" >
            Tomorrow
          </CListGroupItem>
