<footer class="section page-footer page-footer-alternative bg-gray-darker novi-background bg-cover">
    <div class="container container-wide">
        <div class="row row-50 justify-content-sm-center justify-content-xl-between">
            <div class="col-md-6 col-xl-3">
                <h6>About us</h6>
                <p>Brave is a multipurpose and robust HTML template built with modularity at the core. Whether you are
                    building a corporate portfolio or a personal website, Brave has all design and functionality that
                    you may need to establish a great web image.</p>
            </div>
            <div class="col-md-6 col-xl-3">
                <h6>Gallery</h6>
                    ...
                    <div class="row row-10 row-narrow">
                        <div class="col-4">
                            <div class="thumbnail-instafeed thumbnail-instafeed-minimal">
                                <a class="instagram-link" data-lightgallery="item"
                                    href="images/project-1-1200x800-original.jpg">
                                    <img src="images/project-1-570x380.jpg" alt="" width="570" height="380">
                                    <!--img.instagram-image(src='images/_blank.png', alt='', data-images-standard_resolution-url='src')-->
                                </a>
                                <div class="caption">
                        ...
                        <div class="col-4">
                            <div class="thumbnail-instafeed thumbnail-instafeed-minimal">
                                <a class="instagram-link" data-lightgallery="item"
                                    ...
                                    <img src="images/project-2-570x380.jpg" alt="" width="570" height="380">
                                    <!--img.instagram-image(src='images/_blank.png', alt='', data-images-standard_resolution-url='src')-->
                                </a>
                                <div class="caption">
                                    <ul class="list-inline">
                        ...
                        <div class="col-4">
                            <div class="thumbnail-instafeed thumbnail-instafeed-minimal">
                                <a class="instagram-link" data-lightgallery="item"
                                    ...
                                    <img src="images/project-3-570x380.jpg" alt="" width="570" height="380">
                                    <!--img.instagram-image(src='images/_blank.png', alt='', data-images-standard_resolution-url='src')-->
                                </a>
                                <div class="caption">
                                    <ul class="list-inline">
                        ...
                        <div class="col-4">
                            <div class="thumbnail-instafeed thumbnail-instafeed-minimal">
                                <a class="instagram-link" data-lightgallery="item"
                                    ...
                                    <img src="images/project-4-570x380.jpg" alt="" width="570" height="380">
                                    <!--img.instagram-image(src='images/_blank.png', alt='', data-images-standard_resolution-url='src')-->
                                </a>
                                <div class="caption">
                                    <ul class="list-inline">
                        ...
                        <div class="col-4">
                            <div class="thumbnail-instafeed thumbnail-instafeed-minimal">
                                <a class="instagram-link" data-lightgallery="item"
                                    ...
                                    <img src="images/project-5-570x380.jpg" alt="" width="570" height="380">
                                    <!--img.instagram-image(src='images/_blank.png', alt='', data-images-standard_resolution-url='src')-->
                                </a>
                                <div class="caption">
                                    <ul class="list-inline">
                        ...
                        <div class="col-4">
                            <div class="thumbnail-instafeed thumbnail-instafeed-minimal">
                                <a class="instagram-link" data-lightgallery="item"
                                    ...
                                    <img src="images/project-6-570x380.jpg" alt="" width="570" height="380">
                                    <!--img.instagram-image(src='images/_blank.png', alt='', data-images-standard_resolution-url='src')-->
                                </a>
                                <div class="caption">
                                    <ul class="list-inline">
            ...
            <div class="col-md-6 col-xl-3">
                ...
                <ul class="list-xs list-darker">
                    <li class="box-inline">
                        ...
                        <div><span data-novi-id="0">8841 NW 107 Street<br>Hialeah Gardens, FL 33018</span></div>
                    </li>
                    <li class="box-inline">
                    ...
                    <li class="box-inline"><span
                            class="icon novi-icon icon-md-smaller icon-primary mdi mdi-email-open"></span><a
                            href="mailto:#">info@newhopeinchrist.church</a></li>
                </ul>
                <ul class="page-footer-icon-list social-icons-list">
                    <li><a class="icon novi-icon icon-sm-bigger icon-gray-light mdi mdi-facebook" href="#"></a> </li>
            ...
            <div class="col-md-6 col-xl-3">
                <h6>BOLETIN ELECTRONICO</h6>
                <p class="text-spacing-sm">Suscribete a nuestro boletin electronico para estar al dia en todas las cosas
                    grandiosas que estan sucediendo en nuestro ministerio.</p>
                <!-- RD Mailform: Subscribe-->
                <form class="rd-mailform rd-mailform-inline rd-mailform-sm" data-form-output="form-output-global"
