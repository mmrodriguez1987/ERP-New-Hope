...
<head>
  ...
  <title>New Hope In Christ Ministry | CRM</title> 
   <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.4/css/bootstrap.min.css">
   {!! Html::style('css/anime.min.css') !!}
   {!! Html::style('css/font-awesome.min.css') !!}
   {!! Html::style('css/lightbox.css') !!}
   {!! Html::style('css/front.min.css') !!}
   {!! Html::style('css/preset1.min.css') !!}
   {!! Html::style('css/front.responsive.min.css') !!}
    
  <!--[if lt IE 9]>
    <script src="js/oxygen.html5shiv.min.js"></script>
    <script src="js/oxygen.respond.min.js"></script>
  <![endif]-->
...
<body>
  ...
  <footer id="footer">
   ...
   {!! Html::script('js/mousescroll.min.js') !!}
   {!! Html::script('js/smoothscroll.min.js') !!}
   {!! Html::script('js/jquery.countTo.min.js') !!}
   {!! Html::script('js/lightbox.min.js') !!}
   {!! Html::script('js/front.min.js') !!}
</body>
</HTML>